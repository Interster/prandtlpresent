...
\title[Bloodlesshound]{GAL 56 handling qualities} % The short title appears at the bottom of every slide, the full title is only on the title page
...
\begin{itemize}
Presentation on Gal 56. Have more data on this public than sb13
It had all the major ailments of tailless. Look at what not to do. Show nose up moment curve

Show the aero data available on GAL 56
\end{frame}
